...
st.markdown("""
    <div class="center">
        <img src="https://media.tenor.com/oqJq9C6bfjYAAAAI/welcome-images-server.gif" alt="Welcome Image">
    </div>
""", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_path = "https://github.com/gbrl-mar/regresi1_ipk/blob/main/GBR_IPK_model.pkl"
    if os.path.exists(model_path):
        ...
        ing1 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 1.1", 60.0, 98.0)
        ing2 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 1.2", 60.0, 99.0)
        ing3 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 2.1", 60.0, 99.0)
        ing4 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 2.2", 60.0, 99.0)
        ind1 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 1.1", 60.0, 100.0)
        ind2 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 1.2", 60.0, 100.0)
